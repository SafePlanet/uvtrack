...
<div class="col-md-12 col-part-left" style="max-height:480px; overflow-y:auto; -webkit-overflow-scrolling: touch;">
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Manage Route </h3>
        </div>
                                        ...
                                        <form name="routeForm" ng-submit="submitRouteForm()">
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Geometry" ng-model="routeData.geometry"/>
                                                     <label ng-show="detailsVisibility">Fleet Name</label>
                                                   <select  class="form-control" ng-model="routeData.selectedFleet" ng-show="detailsVisibility">
									                                       <option value="">Select Fleet</option> 
												<option ng-repeat="fleet in fleetList" value="{{fleet.fleetId}}">{{fleet.regNumber}}</option> </select>
                                                    <br/>
                                                    <input type="hidden" ng-model="routeData.routeUUID">
                                                    <input type="hidden" ng-model="routeData.routeId">
